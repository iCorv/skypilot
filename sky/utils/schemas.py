...
def get_storage_schema():
    ...
    return {
        ...
        "properties": {
            ...
            "store": {
                "type": "string",
                "case_insensitive_enum": [type.value for type in storage.StoreType],
            },
            "persistent": {
                "type": "boolean",
            },
...
def _experimental_task_schema() -> dict:
    config_override_schema = _filter_schema(
        get_config_schema(), constants.OVERRIDEABLE_CONFIG_KEYS
    )
    return {
        "experimental": {
            "type": "object",
    ...
    cloud_configs = {
        ...
        "gcp": {
            ...
            "properties": {
                ...
                "force_enable_external_ips": {"type": "boolean"},
                **_LABELS_SCHEMA,
                **_NETWORK_CONFIG_SCHEMA,
            },
            **_check_not_both_fields_present("instance_tags", "labels"),
